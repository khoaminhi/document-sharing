...
$route['user/all']['GET'] = 'usercontroller/getAllUserController';
$route['user/register']['get'] = 'usercontroller/insertUser/$1';
$route['user/register']['POST'] = 'usercontroller/insertUser/$1';
